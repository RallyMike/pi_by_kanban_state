...
Ext.define('CustomApp', {
    ...
    gStoryStateMetaDataArray: [], // array to hold the PI's leaf story meta data per state
    ...
    _getLeafStoriesInPi:function (selectedRecord, theStore, thePiRecords) {
        ...
        console.log("piActualStartDate  : " + piActualStartDate);
        console.log("piPlannedEndDate   : " + piPlannedEndDate);
    ...
    _processPiLeafStories:function (store, records) {
        ...
        //this._logStoryStateMetaDataArray(this.gStoryStateMetaDataArray);

        this._chartPiByState(this.gStoryStateMetaDataArray);
    ...
    _processPiStoriesByState:function (theStoryRecords) {
        ...
        for (storyNdx = 0; storyNdx < nbrStories; storyNdx++) {
            ...
            if (storyRecord !== null) {
                ...
                storyStateMetaData = this._findStoryStateMetaDataEntry( this.gStoryStateMetaDataArray, storyState);
                ...
                if (storyStateMetaData === null) {
                    ...
                    this.gStoryStateMetaDataArray.push(storyStateMetaData);
    ...
    _logStoryStateMetaDataArray:function (theStoryStateMetaDataArray) {

        console.log("----- _logStoryStateMetaDataArray() -----");
    ...
    } // end _logStoryStateMetaDataArray
